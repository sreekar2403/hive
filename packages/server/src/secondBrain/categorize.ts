...
const STOPWORDS = new Set([
  ...
  "it", "its", "this", "that", "these", "those", "then", "so", "than", "too",
  "can", "will", "would", "should", "could", "do", "does", "did", "not", "no",
  "please", "i", "we", "you", "my", "our", "me", "us", "also", "just", "now",
  "add", "fix", "make", "update", "change", "create", "use", "using", "want",
  "need", "help", "let", "get", "set", "put", "run", "work", "working",
]);
